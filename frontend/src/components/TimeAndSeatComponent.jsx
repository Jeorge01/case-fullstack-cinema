...
async function handleOnSubmit(e, movie, selectedShow, checkedSeats) {
  ...
  const postData = {
    ...
    title: selectedShow ? movie.title : "", // Check if selectedShow is available
    room: selectedShow ? selectedShow.room : "", // Check if selectedShow is available
    time: selectedShow ? selectedShow.time : "", // Check if selectedShow is available
                      ...
                      .map((seat, index) => (
                        ...
                        >
                          <input
                            ...
                            onChange={() =>
                              handleCheckboxClick(seat.seatNumber, seat.booked)
                            }
      ...
      <form className="bookingSubmit" action="">
        <div className="bookInputs container">
          ...
          <input
            ...
            type="submit"
            onClick={(e) =>
              handleOnSubmit(e, movie, selectedShow, checkedSeats)
            }
            value="Book"
            required
